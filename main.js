const weatherAPIKey = "72ce3f22769ffad17b9cf1f4882ac9f4";
    ...
    navigator.geolocation.getCurrentPosition(position => {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                let weatherTextFahr = `The weather is ${condition} in ${location} and it's ${celsiusToFahr(temperature).toFixed(1)}°F outside.`
                let weatherTextCelsius = `The weather is ${condition} in ${location} and it's ${temperature.toFixed(1)}°C outside.`
